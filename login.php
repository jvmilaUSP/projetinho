...
<body>
    ...
    <div id="tudo">
      ...
      <div id="meio" > 
        ...
        <!-- /Estrutura da Nav -->
        <form action="loginphp.php" method="POST" name="login" enctype="multipart/form-data">
          <div class="divLogin">
            
            <div class="caixaLogin">
                <div class="tituloLogin"><h1>LOGIN</h1></div> 
                ...
                <div class="divBotao">  <div><button>Login</button> </div>  </div>
            </div>
